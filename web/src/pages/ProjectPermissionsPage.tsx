...
export default function ProjectPermissionsPage() {
  ...
  const handleAssignRolePermission = async () => {
    ...
    try {
      await api.post(`/projects/${projectId}/permissions/roles`, {
  ...
  const handleAssignUserPermission = async () => {
    ...
    try {
      await api.post(`/projects/${projectId}/permissions/users`, {
  ...
  const handleRevokePermission = async (permissionId: string) => {
    ...
    try {
      await api.delete(`/project-permissions/${permissionId}`)
      loadPermissions()
    ...
    <>
      ...
      <div className="p-8">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold mb-2">项目权限分配</h1>
          {project && (
            <>
              <p className="text-gray-600">
                项目: <span className="font-semibold">{project.name}</span>
              </p>
              {project.description && (
